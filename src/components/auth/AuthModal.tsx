        ...
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="signup" className="space-y-4 pt-4">
             <form className="space-y-4">
                ...
                <div className="space-y-2">
                    <Label htmlFor="repassword-signup-modal">Ulangi Password</Label>
                    <Input id="repassword-signup-modal" type="password" required />
                </div>
                 <p className="text-xs text-muted-foreground text-center px-4">
                    Dengan mendaftar, Anda setuju dengan{' '}
                    <Link href="/terms-of-service" className="underline hover:text-primary">Syarat & Ketentuan</Link> dan{' '}
                    <Link href="/privacy-policy" className="underline hover:text-primary">Kebijakan Privasi</Link> kami.
                </p>
