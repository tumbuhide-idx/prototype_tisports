...
import { Settings, LogOut, Gift, HelpCircle, Users, GalleryVertical, Bell, Award, History, Share2, User, X } from 'lucide-react';
...
export function DashboardMobileNav() {
  ...
  return (
    <>
        <div className="flex flex-col justify-end bg-gradient-to-b from-secondary to-primary text-primary-foreground p-6">
